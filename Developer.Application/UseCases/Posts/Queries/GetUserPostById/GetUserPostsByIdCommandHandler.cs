...
namespace Developer.Application.UseCases.Posts.Queries.GetUserPostById;

class GetUserPostsByIdCommandHandler : IRequestHandler<GetUserPostsByIdCommand, ActionResult<Response<IEnumerable<UserPostsDto>>>>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IMapper _mapper;

    public GetUserPostsByIdCommandHandler(IUnitOfWork unitOfWork, IMapper mapper)
    {
        _unitOfWork = unitOfWork;
        _mapper = mapper;
    }

    public async Task<ActionResult<Response<IEnumerable<UserPostsDto>>>> Handle(GetUserPostsByIdCommand request, CancellationToken cancellationToken)
    {
